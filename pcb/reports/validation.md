...
- Routing difficulty: strongest reported local region was 8.8% estimated failure probability inside U1's pad field. This is a heuristic, not a routing guarantee. Power routing remains a manual task.
