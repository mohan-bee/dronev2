...
export default function Drone() {
  ...
  return (
    ...
    >
      ...
      <trace from=".BAT1 > .pin1" to="net.VBAT" thickness={0.8} />
      <trace from=".BAT2 > .pin1" to="net.GND" thickness={0.5} />
      ...
      {geometry.motors.map((m) => <trace from={`.${m.name}_NEG > .pin1`}
